...
plot(xp,p1,'r','LineWidth',linewidh,'LineStyle',':')
plot(xp,1-p1,'b','LineWidth',linewidh,'LineStyle',':')
xlabel('t')
ylabel('Probability')
legend('P1','P2','P1 in adiabatic limit','P2 in adiabatic limit')
