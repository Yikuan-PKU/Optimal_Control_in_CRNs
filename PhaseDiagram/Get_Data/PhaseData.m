...
clear all;
T=30;
global X Y t12 t23 t13; %% t12 or K12 is C12; t23 or K23 is C23; t13 or K13 is C13
K12s=[5];
index=0:0.05:6;
K13s=exp(index);
K23s=exp(index);
...
for i=1:1:K12Lth
    for j=1:1:K13Lth
        for k=1:1:K23Lth
            try
                X=linspace(0,T,71);Y=[sort(0.1:0.01:0.8,'descend');0.1:0.01:0.8;zeros(1,71)-1/T;zeros(1,71)+1/T];
                ...
                [p1,p2,p3,k12,k21,k13,k31,k23,k32] = trajectory(Y,t12,t23,t13); 
...
save('K13s.mat','K13s')
save('K23s.mat','K23s')
save('Phasedata_p.mat','Phasedata')
save('rcd.mat','rcd')